      ...
      <main id="top">
        ...
        <section className="metrics section-frame" aria-label="Selected impact metrics">
          ...
          <div className="metric-grid">
            ...
            <article className="metric-card"><span className="metric-index">03 / TRANSFORMATION</span><strong>4<span>+</span> <small>Years</small></strong><h3>Leading B2C Digital Transformation</h3><p>300+ Screens Delivered</p><div className="metric-corner" /></article>
          </div>
        </section>
        ...
        <section id="work" className="work section-frame content-section">
          ...
          <div className="project-grid">
            <a className="project-card project-featured" href="#work/stc"><div className="project-image project-image-stc"><img src={stcScreenshotImg} alt="B2C digital transformation project screens" loading="lazy" /></div><div className="project-content"><div className="project-meta"><span>01</span><span>Telecom · Enterprise UX · Digital Transformation</span></div><h3>B2C Digital Transformation</h3><p>Redesigning complex B2C order management experiences across Prepaid, Postpaid, and Landline services.</p><div className="project-footer"><span>35% reduction in order creation time · 300+ screens</span><span className="project-case-link">View Case Study <ArrowUpRight size={17} /></span></div></div></a>
